...
<script type="text/javascript">
   ...
   function searchId() {
      ...
      if (!memberName) {
         ...
         var param = "memberName=" + memberName + "&email=" + email;
         ...
         httpRequest.open("POST", "momo.do?command=searchId", true);
      ...
      if (httpRequest.readyState === XMLHttpRequest.DONE) {
         if (httpRequest.status === 200) {
             ...
             if (resultText == 1) {
               ...
               alert("아이디 : " +resultText);
               
               opener.document.login.userId.value = resultText;
               
                 self.close();
             }
         } else {
              alert('아이디 찾기에 문제가 있어요.');
         }
      }
   }
</script>
...
<body>
   <div class="wrap-login100">
      <form class="login100-form validate-form">
         ...
         <span class="login100-form-title p-b-34 p-t-27"> ID 찾기 </span>
         ...
         <div class="container-login100-form-btn">
            <button type="button" class="login100-form-btn" onclick="searchId()">찾기</button>
         </div>
      </form>
   </div>
