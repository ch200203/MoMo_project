...
<body>
	...
	<section class="dorne-single-listing-area section-padding-100">
		<div class="container">
			...
			<form action="momo.do?command=writeClassReviewForm" method="post" enctype="multipart/form-data" name="reviewClass">
				<div class="contact-form">
					<div class="row">
						...
						<div class="col-12">
							<h4>
								수업명&nbsp;
								<input type="text" name="className" id="className" style="border:none;">
						...
						<div class="col-12">
							...
							<span style="position:relative; left:80%;">
								<input type="button" class="btn dorne-btn" onclick="location.href='momo.do?command=reviewClassList'" value="작성 취소"></span>
						</div>
					</div>
				</div>
			</form>
